<div class="flex flex-col" style="gap:15px;padding:20px">
			...
			<div class="flex flex-col" style="gap:15px">
				...
				<div class="card card-border" style="border-radius:0px;padding:0">
					<div class="card-heading flex flex-col" style="margin-bottom:10px;background:none">
						<p class="font-medium text-tertiary uppercase text-sm">Sơ chế</p>
					</div>
					<div class="card-body" style="padding:10px">
						<ul style="list-style:inherit;padding-left: 20px;">
							...
							<li>Ướp heo: 0,1 mc nước mắm, 0,2 mc dầu hào, 0,2 mc dầu hào, 0,2 mc dầu hào, 0,2 mc dầu hào,
								0,2 mc
	...
	<div class="input">
		<label for="" class="input-label">Sơ chế phần mặn</label>
		<textarea name="" class="input-control" id="" rows="5"></textarea>
	</div>
	<div class="input">
		<label for="" class="input-label">Sơ chế rau</label>
		<textarea name="" class="input-control" id="" rows="5"></textarea>
	</div>
</div>